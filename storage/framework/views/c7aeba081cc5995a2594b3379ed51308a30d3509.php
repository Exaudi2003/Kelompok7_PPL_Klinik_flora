    ...
    <table class="table table-hover results table-bordered table-sm">
      ...
      <tbody class="text-center">
        ...
        <tr >
            ...
            <td>
                <a href="<?php echo e(route('show.patient', $item->id)); ?>" rel="tooltip" class="btn btn-success btn-sm">
...
<?php echo $__env->make('layouts.mainApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJEK PPL\PPL-Klinik-Flora\resources\views/dokter/show_medical_record.blade.php ENDPATH**/ ?>