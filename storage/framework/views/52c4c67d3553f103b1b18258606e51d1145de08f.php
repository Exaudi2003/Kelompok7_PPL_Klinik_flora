...
<head>
    ...
    <div class="dropdown mb-1">
        ...
        <div class="dropdown-menu" aria-labelledby="filterDropdown">
            <a class="dropdown-item" href="<?php echo e(route('obat.show.dokter')); ?>">Semua</a>
            <a class="dropdown-item" href="<?php echo e(route('obat.show.dokter', ['filter' => 'tersedia'])); ?>">Tersedia</a>
            <a class="dropdown-item" href="<?php echo e(route('obat.show.dokter', ['filter' => 'habis'])); ?>">Habis</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.mainApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJEK PPL\PPL-Klinik-Flora\resources\views/dokter/show_obat.blade.php ENDPATH**/ ?>