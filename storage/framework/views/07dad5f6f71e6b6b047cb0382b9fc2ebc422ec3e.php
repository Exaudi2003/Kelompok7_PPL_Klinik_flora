...
<head>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src=<?php echo e(asset('img/logo.png')); ?> alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src=<?php echo e(asset('img/logo.png')); ?> class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/createAsisten')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('mRecord.create.view')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<!-- js search -->
<script src="<?php echo e(asset('js/tabelPasien.js')); ?>"></script>
...
<?php /**PATH C:\PROJEK PPL\PPL-Klinik-Flora\resources\views/layouts/mainApp.blade.php ENDPATH**/ ?>