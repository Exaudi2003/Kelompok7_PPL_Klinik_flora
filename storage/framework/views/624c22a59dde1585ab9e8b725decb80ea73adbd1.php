  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <a href="#">
            <img src=<?php echo e(asset('img/medical-team.png')); ?> class="img-circle elevation-2" alt="User Image">
          </a>
        </div>
        <div class="info">
          <a href="#" class="d-block">Welcome Asisten, <?php echo e(auth()->user()->name); ?></a>
        </div>
      </div>
...
<?php /**PATH C:\PROJEK PPL\PPL-Klinik-Flora\resources\views/layouts/mainAppAsisten.blade.php ENDPATH**/ ?>